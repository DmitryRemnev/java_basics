...
public class Task4_Exam {
    ...
    public static Map<TruckType, List<Truck>> groupTrucksByType(List<Truck> trucks) {
        return trucks.stream().collect(Collectors.groupingBy(truck -> Task4_Exam.getTypeByWeight(truck.maxWeightKg)));
    }
    ...
    public static Map<TruckType, Long> countTrucksByType(List<Truck> trucks) {
        return trucks.stream().collect(Collectors.groupingBy(truck -> Task4_Exam.getTypeByWeight(truck.maxWeightKg), Collectors.counting()));
    }
